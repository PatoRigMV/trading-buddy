...
import { PerHostRateLimiter } from '../src/data/rateLimiter';
import { PerHostCircuitBreaker } from '../src/data/circuitBreaker';
import { createRapidAPIClient } from '../src/data/RapidAPIClient';
describe('RapidAPI Components', () => {
    ...
    describe('RapidAPIClient', () => {
        ...
        it('should include proper RapidAPI headers', async () => {
            ...
            expect(global.fetch).toHaveBeenCalledWith(expect.stringContaining('twelvedata.p.rapidapi.com'), expect.objectContaining({
